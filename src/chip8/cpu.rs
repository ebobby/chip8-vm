...
impl Cpu {
    ...
    fn decode(&self, inst: u16) -> Opcode {
        match utils::u16_to_nibbles(inst) {
            ...
            (0x3, x, n1, n2) => Opcode::SeByte(Reg::V(x), utils::nibbles_to_u8(n1, n2)),
            (0x4, x, n1, n2) => Opcode::SneByte(Reg::V(x), utils::nibbles_to_u8(n1, n2)),
            (0x5, x, y, 0x0) => Opcode::Se(Reg::V(x), Reg::V(y)),
            ...
            (0x9, x, y, 0x0) => Opcode::Sne(Reg::V(x), Reg::V(y)),
            ...
            (0xE, x, 0x9, 0xE) => Opcode::Skp(Reg::V(x)),
            (0xE, x, 0xA, 0x1) => Opcode::Sknp(Reg::V(x)),
...
enum Opcode {
    ...
    SeByte(Reg, u8),    //            3xkk - SE Vx, byte
    SneByte(Reg, u8),   //            4xkk - SNE Vx, byte
    Se(Reg, Reg),       //            5xy0 - SE Vx, Vy
